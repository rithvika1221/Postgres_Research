#!/usr/bin/env python3
"""
Load Generator — 16 users (-c 16 -j 8), Variable Throughput
Experiment: 16 users (-c 16 -j 8) with TPS stepping every 2 minutes

TPS Schedule:
  Phase 1 (0:00 - 2:00)  ->  100 TPS   (6 TPS per worker)
  Phase 2 (2:00 - 4:00)  ->  500 TPS   (31 TPS per worker)
  Phase 3 (4:00 - 6:00)  -> 1000 TPS   (62 TPS per worker)
  Phase 4 (6:00 - 8:00)  -> 2500 TPS   (156 TPS per worker)
  Phase 5 (8:00 - 10:00) -> 5000 TPS   (312 TPS per worker)

16 parallel workers split the target TPS evenly between them.
...
def main():
    parser = argparse.ArgumentParser(description="16 users (-c 16 -j 8) variable TPS load generator")
    ...
    print("  Experiment: 16 users (-c 16 -j 8), Variable Throughput")
    print("=" * 65)
