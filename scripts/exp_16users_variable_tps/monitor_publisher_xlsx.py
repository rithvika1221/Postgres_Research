#!/usr/bin/env python3
"""
Publisher Replication Monitor — 16 users (-c 16 -j 8), Variable Throughput
...
def main():
    ...
    outfile = f"publisher_metrics_16users_varTPS_{ts}.xlsx"
    outpath = os.path.join(args.output_dir, outfile)

    print("=" * 65)
    print("  Publisher Monitor — 16 users (-c 16 -j 8), Variable TPS")
    print("=" * 65)
