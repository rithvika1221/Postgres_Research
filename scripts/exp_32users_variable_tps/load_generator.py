#!/usr/bin/env python3
"""
Load Generator — 32 users (-c 32 -j 16), Variable Throughput
Experiment: 32 users (-c 32 -j 16) with TPS stepping every 2 minutes

TPS Schedule:
  Phase 1 (0:00 - 2:00)  ->  100 TPS   (3 TPS per worker)
  Phase 2 (2:00 - 4:00)  ->  500 TPS   (15 TPS per worker)
  Phase 3 (4:00 - 6:00)  -> 1000 TPS   (31 TPS per worker)
  Phase 4 (6:00 - 8:00)  -> 2500 TPS   (78 TPS per worker)
  Phase 5 (8:00 - 10:00) -> 5000 TPS   (156 TPS per worker)

32 parallel workers split the target TPS evenly between them.
...
def main():
    parser = argparse.ArgumentParser(description="32 users (-c 32 -j 16) variable TPS load generator")
    ...
    print("  Experiment: 32 users (-c 32 -j 16), Variable Throughput")
    print("=" * 65)
