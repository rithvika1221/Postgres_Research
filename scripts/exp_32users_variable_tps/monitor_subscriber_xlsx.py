#!/usr/bin/env python3
"""
Subscriber Replication Monitor — 32 users (-c 32 -j 16), Variable Throughput
...
def main():
    ...
    outfile = f"subscriber_metrics_32users_varTPS_{ts}.xlsx"
    outpath = os.path.join(args.output_dir, outfile)

    print("=" * 65)
    print("  Subscriber Monitor — 32 users (-c 32 -j 16), Variable TPS")
    print("=" * 65)
