#!/usr/bin/env python3
"""
Publisher Replication Monitor — 64 users (-c 64 -j 16), Variable Throughput
...
def main():
    ...
    outfile = f"publisher_metrics_64users_varTPS_{ts}.xlsx"
    outpath = os.path.join(args.output_dir, outfile)

    print("=" * 65)
    print("  Publisher Monitor — 64 users (-c 64 -j 16), Variable TPS")
    print("=" * 65)
