#!/usr/bin/env python3
"""
Load Generator — 8 users (-c 8 -j 8), Variable Throughput
Experiment: 8 users (-c 8 -j 8) with TPS stepping every 2 minutes

TPS Schedule:
  Phase 1 (0:00 - 2:00)  ->  100 TPS   (12 TPS per worker)
  Phase 2 (2:00 - 4:00)  ->  500 TPS   (62 TPS per worker)
  Phase 3 (4:00 - 6:00)  -> 1000 TPS   (125 TPS per worker)
  Phase 4 (6:00 - 8:00)  -> 2500 TPS   (312 TPS per worker)
  Phase 5 (8:00 - 10:00) -> 5000 TPS   (625 TPS per worker)

8 parallel workers split the target TPS evenly between them.
...
def main():
    parser = argparse.ArgumentParser(description="8 users (-c 8 -j 8) variable TPS load generator")
    ...
    print("  Experiment: 8 users (-c 8 -j 8), Variable Throughput")
    print("=" * 65)
