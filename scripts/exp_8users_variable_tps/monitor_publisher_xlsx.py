#!/usr/bin/env python3
"""
Publisher Replication Monitor — 8 users (-c 8 -j 8), Variable Throughput
...
def main():
    ...
    outfile = f"publisher_metrics_8users_varTPS_{ts}.xlsx"
    outpath = os.path.join(args.output_dir, outfile)

    print("=" * 65)
    print("  Publisher Monitor — 8 users (-c 8 -j 8), Variable TPS")
    print("=" * 65)
