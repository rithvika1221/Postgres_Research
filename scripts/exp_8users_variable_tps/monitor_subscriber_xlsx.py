#!/usr/bin/env python3
"""
Subscriber Replication Monitor — 8 users (-c 8 -j 8), Variable Throughput
...
def main():
    ...
    outfile = f"subscriber_metrics_8users_varTPS_{ts}.xlsx"
    outpath = os.path.join(args.output_dir, outfile)

    print("=" * 65)
    print("  Subscriber Monitor — 8 users (-c 8 -j 8), Variable TPS")
    print("=" * 65)
